...
public class OrderDataMapper {
    public Restaurant createOrderCommandToRestaurant(CreateOrderCommand createOrderCommand) {
        HashMap<UUID, Product> productsMap = new HashMap<UUID, Product>();
        createOrderCommand.getItems().forEach(product -> productsMap.put(product.getProductId(), new Product(new ProductId(product.getProductId()))));
