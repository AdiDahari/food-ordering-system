...
import dev.adidahari.food.ordering.system.order.service.domain.ports.input.message.listener.restaurantapproval.RestaurantApprovalResponseMessageListener;
            ...
            if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()) {
                ...
                log.info("Processing rejected order for order id: {}, with failure messages: {}",
                        ...
                        String.join(FAILURE_MESSAGES_DELIMITER,
                                restaurantApprovalResponseAvroModel.getFaliureMessages()));
