package dev.adidahari.food.ordering.system.payment.service.messaging.mapper;

import dev.adidahari.food.ordering.system.domain.valueobject.PaymentOrderStatus;
...
public class PaymentMessagingDataMapper {
    ...
    public PaymentRequest paymentRequestAvroModelToPaymentRequest(PaymentRequestAvroModel paymentRequestAvroModel) {
        return PaymentRequest.builder()
                ...
                .paymentOrderStatus(PaymentOrderStatus.valueOf(paymentRequestAvroModel.getPaymentStatus().name()))
                .build();
    }
}
