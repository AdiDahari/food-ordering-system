package dev.adidahari.food.ordering.system.payment.service.messaging.listener.kafka;

import dev.adidahari.food.ordering.system.kafka.consumer.KafkaConsumer;
import dev.adidahari.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus;
...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    public void receive(@Payload List<PaymentRequestAvroModel> messages,
        ...
        messages.forEach(paymentRequestAvroModel -> {
            if (PaymentOrderStatus.PENDING == paymentRequestAvroModel.getPaymentStatus()) {
                log.info("Processing payment for order with id: {}", paymentRequestAvroModel.getOrderId());
            ...
            } else if (PaymentOrderStatus.CANCELLED == paymentRequestAvroModel.getPaymentStatus()) {
                log.info("Cancelling payment for order with id: {}", paymentRequestAvroModel.getOrderId());
