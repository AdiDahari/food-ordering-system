package dev.adidahari.food.ordering.system.restaurant.service.domain.entity;
...
import dev.adidahari.food.ordering.system.domain.valueobject.OrderStatus;
    ...
    public void validateOrder(List<String> failureMessages) {
        ...
        Money totalAmount = orderDetail.getProducts().stream().map(product -> {
            if (product.isAvailable()) {
                failureMessages.add("Product with id: " + product.getId().getValue() + " is unavailable");
            }
