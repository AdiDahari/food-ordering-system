package dev.adidahari.food.ordering.system.kafka.consumer.config;

import dev.adidahari.food.ordering.system.kafka.config.data.KafkaConfigData;
import dev.adidahari.food.ordering.system.kafka.config.data.KafkaConsumerConfigData;
